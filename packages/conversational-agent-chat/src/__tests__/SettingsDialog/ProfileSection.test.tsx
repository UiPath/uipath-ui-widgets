...
describe("ProfileSection", () => {
  ...
  it("coerces legacy EV country code to SV on load", async () => {
    const { agent } = makeAgent({ country: "EV" });
    render(<ProfileSection conversationalAgent={agent} />);
    // Autocomplete renders the translated country name for the SV option.
    expect(await screen.findByDisplayValue("El Salvador")).toBeInTheDocument();
  });

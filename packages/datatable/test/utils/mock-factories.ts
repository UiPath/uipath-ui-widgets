...
import { EntityGetResponse, FieldMetaData, EntityFieldDataType } from '@uipath/uipath-typescript'
...
export const createMockField = (overrides?: Partial<FieldMetaData>): FieldMetaData => ({
  name: 'testField',
...
export const createMockEntity = (overrides?: Partial<EntityGetResponse>): EntityGetResponse => ({
  id: 'entity-1',
  name: 'TestEntity',

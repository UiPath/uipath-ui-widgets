...
describe('CellWithExpandButton', () => {
  ...
  it('should call onToggleExpand with cellId when button is clicked', async () => {
    ...
    render(<CellWithExpandButton {...defaultProps} onToggleExpand={onToggleExpand} />)
  ...
  it('should stop event propagation when button is clicked', async () => {
    ...
    render(
      <div onClick={onDivClick}>
        <CellWithExpandButton {...defaultProps} onToggleExpand={onToggleExpand} />
      </div>
    )
  ...
  it('should render with different cell names', () => {
    const { rerender } = render(<CellWithExpandButton {...defaultProps} cellName="First Name" />)

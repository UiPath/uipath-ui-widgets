import{j as t}from"./jsx-runtime-C5WNSv3b.js";import{U as I}from"./tslib.es6-CYjveIzL.js";import{r as b}from"./iframe-DCTdnP6k.js";import{C as x}from"./ConversationalAgentChat-XpAvMVf9.js";import"./preload-helper-PPVm8Dsz.js";import"./jsep-mio_-mSh.js";import"./index-BqgQSHrq.js";import"./index-MhVYYYQq.js";import"./compiler-runtime-BlAP1C1Q.js";import"./endOfMonth-a6ok6bB8.js";const D=({baseUrl:e,orgName:r,tenantName:a,secret:n,...C})=>{const[v,g]=b.useState({sdk:null,error:null});b.useEffect(()=>{if(!e||!r||!a||!n)return;let m=!1;return(async()=>{try{const o=e.match(/^https?:\/\//)?e:`https://${e}`,w=new I({baseUrl:o,orgName:r,tenantName:a,secret:n});await w.initialize(),m||g({sdk:w,error:null})}catch(o){m||g({sdk:null,error:o instanceof Error?o.message:"Failed to initialize SDK"})}})(),()=>{m=!0}},[e,r,a,n]);const{sdk:f,error:y}=v;return!e||!r||!a||!n?t.jsx("div",{style:{padding:24,color:"#666"},children:"Please provide baseUrl, orgName, tenantName, and secret in the controls panel below."}):y?t.jsxs("div",{style:{padding:24,color:"#d32f2f"},children:["SDK initialization failed: ",y]}):f?t.jsx(x,{sdk:f,...C}):t.jsx("div",{style:{padding:24},children:"Initializing SDK..."})},z={title:"Components/ConversationalAgentChat",component:D,decorators:[e=>t.jsx("div",{style:{height:"600px"},children:t.jsx(e,{})})],parameters:{layout:"padded",docs:{description:{component:`
...
}`,...h.parameters?.docs?.source}}};const K=["Default","DarkTheme","Japanese","ReadOnly","CustomLabels","ExistingConversation","CustomFirstRun","DisabledFeatures"];export{u as CustomFirstRun,l as CustomLabels,i as DarkTheme,s as Default,h as DisabledFeatures,p as ExistingConversation,c as Japanese,d as ReadOnly,K as __namedExportsOrder,z as default};

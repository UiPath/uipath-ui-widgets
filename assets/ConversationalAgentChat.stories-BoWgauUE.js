import{j as t}from"./jsx-runtime-C5WNSv3b.js";import{U as C}from"./index-Dxcz6xcn.js";import{r as b}from"./iframe-D55jccVQ.js";import{C as x}from"./ConversationalAgentChat-Cy8So4f5.js";import"./preload-helper-PPVm8Dsz.js";import"./button-C84BYgB5.js";import"./label-B5Ou6GCM.js";import"./x-C-ONAuDA.js";import"./index-BHNEAPuM.js";import"./index-Bl4Ly0ci.js";import"./tslib.es6-DOyTwyrN.js";import"./client-BurTtbV3.js";import"./compiler-runtime-D77Sb75J.js";import"./index-D4OEb50b.js";const I=({baseUrl:e,orgName:r,tenantName:a,secret:n,...w})=>{const[v,m]=b.useState({sdk:null,error:null});b.useEffect(()=>{if(!e||!r||!a||!n)return;let h=!1;return(async()=>{try{const o=e.match(/^https?:\/\//)?e:`https://${e}`,y=new C({baseUrl:o,orgName:r,tenantName:a,secret:n});await y.initialize(),h||m({sdk:y,error:null})}catch(o){h||m({sdk:null,error:o instanceof Error?o.message:"Failed to initialize SDK"})}})(),()=>{h=!0}},[e,r,a,n]);const{sdk:g,error:f}=v;return!e||!r||!a||!n?t.jsx("div",{style:{padding:24,color:"#666"},children:"Please provide baseUrl, orgName, tenantName, and secret in the controls panel below."}):f?t.jsxs("div",{style:{padding:24,color:"#d32f2f"},children:["SDK initialization failed: ",f]}):g?t.jsx(x,{sdk:g,...w}):t.jsx("div",{style:{padding:24},children:"Initializing SDK..."})},T={title:"Components/ConversationalAgentChat",component:I,decorators:[e=>t.jsx("div",{style:{height:"600px"},children:t.jsx(e,{})})],parameters:{layout:"padded",docs:{description:{component:`
...
}`,...u.parameters?.docs?.source}}};const q=["Default","DarkTheme","ReadOnly","CustomLabels","ExistingConversation","CustomFirstRun","DisabledFeatures"];export{p as CustomFirstRun,d as CustomLabels,i as DarkTheme,s as Default,u as DisabledFeatures,l as ExistingConversation,c as ReadOnly,q as __namedExportsOrder,T as default};
